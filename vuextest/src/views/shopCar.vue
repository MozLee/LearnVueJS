  ...
  <div class="shop-cart">
    ...
    <div class="content">
      ...
      <div class="cart-goods-list">
        <!--购物车表头-->
        <div class="list-head clearfix"  v-if="!loading">
        ...
        <!--购物车展示商品信息-->
        <div class="list-body">
          <shop-item-box v-for = "item in shopList" :key="item.skuId" :shop-info="item"></shop-item-box>
        </div>
      </div>
      <!--计算价钱的信息-->
      <shop-info v-if="!loading"></shop-info>
    </div>
    <recommend v-if="!loading"></recommend>
  </div>
</template>
<script>
...
export default {
  ...
  created(){
    ...
    this.$store.dispatch('getRecommendedListAction')
  },
  computed:{
     shopList(){
